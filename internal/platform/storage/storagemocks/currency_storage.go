...
// CurrencyStorage is an autogenerated mock type for the CurrencyStorage type
type CurrencyStorage struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, response
func (_m *CurrencyStorage) Create(ctx context.Context, response domain.ResponseSync) error {
...
func (_m *CurrencyStorage) GetAll(ctx context.Context, finit time.Time, fend time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetAllWithOnlyFend(ctx context.Context, fend time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetAllWithOnlyFinit(ctx context.Context, finit time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetAllWithoutDates(ctx context.Context) (domain.ResponsesCurrencyGet, error) {
	ret := _m.Called(ctx)
...
func (_m *CurrencyStorage) GetByCode(ctx context.Context, code string, finit time.Time, fend time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetByCodeWithOnlyFend(ctx context.Context, code string, fend time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetByCodeWithOnlyFinit(ctx context.Context, code string, finit time.Time) (domain.ResponsesCurrencyGet, error) {
...
func (_m *CurrencyStorage) GetByCodeWithoutDates(ctx context.Context, code string) (domain.ResponsesCurrencyGet, error) {
...
type mockConstructorTestingTNewCurrencyStorage interface {
	mock.TestingT
	Cleanup(func())
}

// NewCurrencyStorage creates a new instance of CurrencyStorage. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewCurrencyStorage(t mockConstructorTestingTNewCurrencyStorage) *CurrencyStorage {
	mock := &CurrencyStorage{}
	mock.Mock.Test(t)
